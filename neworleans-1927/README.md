...
The band is the one file, `assets/audio/set-1.mp3`: a take generated with MiniMax-Music3 on our own GPUs,
...
밴드만 파일입니다. 자체 GPU에서 MiniMax-Music3로 만든 한 테이크이고, 코넷과 주고받는 보컬이 들어 있습니다.
...
moment you hear it. The take in `assets/audio/` was generated with MiniMax-Music3 on
our own GPUs; its vocal was separated out, re-sung in a licensed speaker timbre, and given
its original melody back.
